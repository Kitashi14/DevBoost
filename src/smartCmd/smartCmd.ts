// SmartCmd module for DevBoost extension
...
// Export activity logging setup function for extension to use
export const setupActivityLogging = activityLogging.setupActivityLogging;

// Create AI-suggested buttons based on activity log
export async function createAIButtons(context: vscode.ExtensionContext, activityLogPath: string | undefined, buttonsProvider: SmartCmdButtonsTreeProvider) {
...
export async function executeButtonCommand(button: Button) {
